...
const sector_intent = {
  ...
  async handle (handlerInput) {
    ...
    if (handlerInput.requestEnvelope.request.intent.slots.sector.value !== undefined && handlerInput.requestEnvelope.request.intent.slots.sector.value.value !== undefined) {
      ...
      if (handlerInput.requestEnvelope.request.intent.slots.sector.value) {
        sector = handlerInput.requestEnvelope.request.intent.slots.sector.resolutions.resolutionsPerAuthority[0].values[0].value.name
      } else if ((!handlerInput.requestEnvelope.request.intent.slots.sector.value) && (sessionAttributes)) {
        sector = sessionAttributes.sector_region
      }
    }
    ...
    if (handlerInput.requestEnvelope.request.intent.slots.region.value !== undefined && handlerInput.requestEnvelope.request.intent.slots.region.value.value !== undefined) {
      ...
      if (handlerInput.requestEnvelope.request.intent.slots.region.value) {
        region = handlerInput.requestEnvelope.request.intent.slots.region.value
